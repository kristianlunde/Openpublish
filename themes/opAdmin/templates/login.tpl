<div id="loginBox">
    ...
    <form method="post" action="/admin/login" id="adminForm" style="padding: 20px;">
            ...
            if ($captchaEnabled) {
                echo '<li>
                        <span class="input-shadow">
                            <img src="/admin/captcha" alt="Captcha" title="Captcha" class="captcha-img" />
                        </span>
                      </li>
                      <li>
        ...
        <div id="buttons"><a href="#" onclick="$('#adminForm').submit();" class="form_btn"><span><img class="table-icon" src="/themes/opAdmin/images/icons/tick.png" alt="" width="16" height="16"/> Login</span></a> <a href="/admin/resetPassword" class="form_btn_right"><span><img class="table-icon" src="/themes/opAdmin/images/icons/lock--exclamation.png" alt="" width="16" height="16"/> Reset password</span></a></a></div>
    </form>
</div>