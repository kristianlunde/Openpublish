<div id="loginBox">
    ...
    <form method="post" action="/admin/resetPassword" id="adminForm" style="padding: 20px;">
        ...
        ?>
        <div id="buttons"><a href="/admin/login" class="form_btn"><span><img class="table-icon" src="/themes/opAdmin/images/icons/tick.png" alt="" width="16" height="16"/> OK</span></a></div>
    </form>
</div>