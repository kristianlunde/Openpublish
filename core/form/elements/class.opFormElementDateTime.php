 ...
 */
class opFormElementDateTime extends opFormElement {
    ...
    public function getHtml() {
        $script = '<script>
        			$(function() {
                        ...
                        $(\'#'.$this->elementName.'\').datetimepicker({dateFormat: \'yy-mm-dd\', constrainInput: false, onSelect: function(dateText, inst) {
        ...
        '<span class="btn-refresh">
        	<a href="javascript:;" onclick="javascript:$(\'#'.$this->elementName.'\').val(\'0000-00-00 00:00\').datepicker(\'hide\');" id="datePickerBtn_'.$this->elementName.'" class="form_btn_input" title="'.opTranslation::getTranslation('_select_date').'"><span><img src="/themes/opAdmin/images/icons/cross.png" width="16" height="16" border="0" alt="'.opTranslation::getTranslation('_select_date').'" /></span></a></span>';
    }
}
?>