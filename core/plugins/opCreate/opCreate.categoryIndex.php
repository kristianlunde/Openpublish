...
<h3><?php echo opTranslation::getTranslation('_categories', $opPluginName) ?> | <?php echo opTranslation::getTranslation('_create', $opPluginName) ?>
    ...
    <span class="action-right-btns">
        <a href="/admin/opCreate/categoryNew" title="<?php echo opTranslation::getTranslation('_new_category', $opPluginName) ?>"><span><img src="<?php echo $opPluginPath ?>icons/clear-folder--plus.png" width="16" height="16" alt="" class="table-icon" /> <?php echo opTranslation::getTranslation('_new_category', $opPluginName) ?></span></a>
        ...
        <a href="/admin/opCreate" title="<?php echo opTranslation::getTranslation('_back', $opPluginName) ?>"><span><img src="<?php echo $opPluginPath ?>icons/arrow-180-medium.png" width="16" height="16" alt="" title="" class="table-icon" /> <?php echo opTranslation::getTranslation('_back', $opPluginName) ?></span></a>
    </span>
</h3>
<div id="content-plugin">
    <form method="post" id="adminForm" action="/admin/opCreate/categoryDelete">
        ...
        foreach ($cat as $k => $v) {
            echo '<li id="update_'.$v['id'].'">
                        ...
                        <span class="sortTitle"><a href="/admin/opCreate/categoryEdit/'.$v['id'].'">'.$v['name'].'</a></span>
                  </li>';
        }
        ?>
        </ul>
